...
public final class CareGroupService {
    ...
    private void start(final StartServiceEvent event) {
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("1",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("2",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("3",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("3a",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("4",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("5",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("6",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("7",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("7a",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("7b",
        ...
        careGroupRepository.save(this.updateCareGroupVersion(careGroups, new CareGroup("8",
