...
public final class CactusHistoryEndpointCollection {
  ...
  public CactusHistoryEndpointCollection(final CactusRepository cactusRepository, final CactusHistoryRepository cactusHistoryRepository) {
    this.cactusRepository = cactusRepository;
    this.cactusHistoryRepository = cactusHistoryRepository;
  }
